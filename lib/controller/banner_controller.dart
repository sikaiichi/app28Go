...
class BannerController extends GetxController implements GetxService {
  ...
  Future<BasicCampaignModel> getAds() async {
    BasicCampaignModel adsModel = new BasicCampaignModel();
    Response response = await bannerRepo.getAds();
    if (response.statusCode == 200) {
      adsModel = BasicCampaignModel.fromJson(response.body);
    }
    return adsModel;
  }
