class ConfigModel {
  ...
  bool? additionalMaxChargeStatus;
  String? additionalMaxChargeName;
  double? additionMaxCharge;
  ...
  ConfigModel(
      {this.businessName,
        ...
        this.additionCharge,
        this.additionalMaxChargeStatus,
        this.additionalMaxChargeName,
        this.additionMaxCharge,
        this.bannerData,
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    additionalMaxChargeName = json['additional_max_charge_name'];
    additionalMaxChargeStatus = json['additional_max_charge_status'] == 1;
    additionMaxCharge = json['additional_max_charge']?.toDouble() ?? 0;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['additional_max_charge_status'] = additionalMaxChargeStatus;
    data['additional_max_charge_name'] = additionalMaxChargeName;
    data['additional_max_charge'] = additionMaxCharge;
