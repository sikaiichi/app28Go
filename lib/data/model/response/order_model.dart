...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    additionalMaxCharge = json['additional_max_charge']?.toDouble() ?? 0;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['additional_max_charge'] = additionalMaxCharge;
