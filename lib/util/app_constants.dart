...
class AppConstants {
  static const String appName = '28Go';
  static const double appVersion = 7.2;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'https://shopping.28go.vn';

  static const String baseUrl = 'https://doitac.28go.vn';
  static const String categoryUri = '/api/v1/categories';
  static const String bannerUri = '/api/v1/banners';
  static const String adsUri = '/api/v1/banners/ads';
  ...
  /// Deep Links
  static const String yourScheme = '28Go';
  static const String yourHost = '28go.vn';
