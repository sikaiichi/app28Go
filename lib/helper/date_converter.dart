...
class DateConverter {
  ...
  static String dateToDateAndTimeAm(DateTime dateTime) {
    return DateFormat('dd-MM-yyyy ${_timeFormatter()}').format(dateTime);
  }
  ...
  static String isoStringToDateTimeString(String dateTime) {
    return DateFormat('dd-MM-yyyy  ${_timeFormatter()}').format(isoStringToLocalDate(dateTime));
  }
  ...
  static String isoStringToLocalDateTimeOnly(String dateTime) {
    return DateFormat('dd-MM-yyyy HH:mm a').format(isoStringToLocalDate(dateTime));
  }
  ...
  static String containTAndZToUTCFormat(String time) {
    ...
    return DateFormat('dd-MM-yyyy').format(DateFormat('yyyy-MM-dd HH:mm:ss').parse(newTime));
    // return DateFormat('${_timeFormatter()} | d-MMM-yyyy ').format(dateTime.toLocal());
  }
