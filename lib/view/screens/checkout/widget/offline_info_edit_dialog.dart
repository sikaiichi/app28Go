...
class OfflineInfoEditDialog extends StatefulWidget {
  ...
  const OfflineInfoEditDialog({Key? key, required this.offlinePayment, required this.orderId, required this.contactNumber}) : super(key: key);
                  ...
                  child: Column(children: [
                    ...
                    Row(children: [
                      ...
                      CustomButton(
                        ...
                        isLoading: orderController.isLoadingUpdate,
                        onPressed: () {
                          ...
                          for(int i=0; i<orderController.informationControllerList.length; i++){
                            if(orderController.informationControllerList[i].text.isEmpty) {
                              ...
                              orderController.updateOfflineInfo(jsonEncode(data)).then((success) {
                                if(success) {
                                  Get.find<OrderController>().timerTrackOrder(widget.orderId.toString(), contactNumber: widget.contactNumber).then((response) {
