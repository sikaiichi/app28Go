...
class OfflinePaymentButton extends StatelessWidget {
  ...
  const OfflinePaymentButton({Key? key, required this.isSelected, required this.offlineMethodList, required this.isOfflinePaymentActive, required this.onTap,
    required this.orderController, required this.tooltipController}) : super(key: key);
        ...
        child: Column(children: [
          ...
          isSelected ? GridView.builder(
            ...
            itemBuilder: (context, index) {
              bool isSelected = orderController.selectedOfflineBankIndex == index;
              return InkWell(
                onTap: () => orderController.selectOfflineBank(index),
                child: Container(
                  decoration: BoxDecoration(
...
class OfflinePaymentTooltipNoteWidget extends StatelessWidget {
  final String note;
  const OfflinePaymentTooltipNoteWidget({Key? key, required this.note}) : super(key: key);
