          ...
          DateConverter.isBeforeTime(order.scheduleAt) ? (!cancelled && ongoing && !subscription) ? Column(children: [
            ...
            Center(
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('phút'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor)),
              ]),
            ),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                      '${order.deliveryMan!.loaixe} (${order.deliveryMan!.mauxe})| ${order.deliveryMan!.bks}',
                      maxLines: 1, overflow: TextOverflow.ellipsis,
                      style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)
                  ),
                ])),
