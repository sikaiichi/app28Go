      ...
      child: Column(children: [
        ...
        Padding(
          ...
          child: Column(children: [
            ...
            (order.additionalMaxCharge != null && order.additionalMaxCharge! > 0) ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(Get.find<SplashController>().configModel!.additionalMaxChargeName!, style: robotoRegular),
              Text('(+) ${PriceConverter.convertPrice(order.additionalMaxCharge)}', style: robotoRegular, textDirection: TextDirection.ltr),
            ]) : const SizedBox(),
            (order.additionalMaxCharge != null && order.additionalMaxCharge! > 0) ? const SizedBox(height: 10) : const SizedBox(),
