    ...
    return WillPopScope(
      ...
      child: GetBuilder<OrderController>(builder: (orderController) {
          ...
          if(orderController.orderDetails != null && order != null) {
            ...
            additionalMaxCharge = order.additionalMaxCharge!;
          ...
          double total = itemsPrice + addOns - discount! + (taxIncluded! ? 0 : tax!) + deliveryCharge! - couponDiscount! + dmTips! + additionalCharge + additionalMaxCharge;
