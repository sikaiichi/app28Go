...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          SafeArea(child: GetBuilder<UserController>(builder: (userController) {
        if (widget.address != null) {
  ...
  Widget informationSectionWidget(LocationController locationController) {
    return Container(
      ...
      */
        // Ẩn địa chỉ ở ô thêm địa chỉ mới
        ResponsiveHelper.isDesktop(context)
            ? saveButton(locationController)
            : const SizedBox(),
        const SizedBox(height: Dimensions.paddingSizeLarge),
          ...
          ? CustomButton(
              ...
              onPressed: locationController.loading
                  ...
                  : () async {
                      ...
                      print('phoneValid ${phoneValid.isValid}');
                      if (_contactPersonNameController.text.isEmpty) {
                        showCustomSnackBar(
                            'please_provide_contact_person_name'.tr);
