...
class CustomWebSliderWidget extends StatefulWidget {
  ...
  const CustomWebSliderWidget({Key? key, required this.height, required this.productList, this.showCount = 4, required this.child, required this.weight, required this.indexCallBack}) : super(key: key);
