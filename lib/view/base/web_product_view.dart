...
import 'package:efood_multivendor/view/base/web_product_widget.dart';
...
class WebProductView extends StatelessWidget {
  ...
  const WebProductView({Key? key, required this.restaurants, required this.products, required this.isRestaurant, this.isScrollable = false,
